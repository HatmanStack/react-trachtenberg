...
export const TUTORIAL_STEP_COUNT = 21;
...
export const tutorialSteps: readonly TutorialStep[] = [
  ...
  {
    id: 2,
    explanation: "Find the First Digit",
  ...
  {
    id: 18,
    explanation: "Understanding Zero Padding",
    answer: "As we multiply, we need to access digit positions that may not exist in shorter numbers.\n\nFor example, if multiplying 1234 × 567, we may need to access the 5th or 6th position of 1234.",
    bottomArrow: "6784"
  },
  {
    id: 19,
    explanation: "How Zero Padding Works",
    answer: "We add leading zeros as needed:\n\n1234 becomes 001234\n\nThis allows us to access positions 1-6 consistently throughout the calculation.",
    bottomArrow: "6784"
  },
  {
    id: 20,
    explanation: "Why Padding Matters",
    answer: "When a digit position doesn't exist (like position 5 in 1234), we treat it as 0.\n\nPadding makes this explicit and prevents errors.\n\nYou'll see this in practice mode when hints are enabled.\n\nClick Next to Practice",
    bottomArrow: "6784"
  }
] as const;
